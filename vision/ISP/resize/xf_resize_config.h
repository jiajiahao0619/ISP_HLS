...
#define scaleW  5//放大倍数
#define scaleH  5

/* Output image Dimensions */
#define NEWWIDTH (128*scaleW)  // Maximum output image width
#define NEWHEIGHT (128*scaleH) // Maximum output image height
//#define NEWWIDTH  720 // Maximum output image width
//#define NEWHEIGHT 640 // Maximum output image height
